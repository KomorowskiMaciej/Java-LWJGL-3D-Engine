package engine.base.resourceManagment.objParser;

import engine.base.resourceManagment.Loader;
import engine.base.resourceManagment.containers.model.Mesh;
import engine.base.resourceManagment.containers.model.Vertex;
...
public class OBJLoader {
    ...
    private static final String RES_LOC = "res/meshes/";
    ...
    public static Mesh loadOBJ(String objFileName) {
        ...
        try {
            while (true) {
                ...
                if (line.startsWith("v ")) {
                    ...
                    String[] currentLine = trimLine.split(" ");
        ...
        // furthest);
        return Loader.getInstance().loadToVAO(verticesArray, texturesArray, normalsArray, indicesArray);
    }
