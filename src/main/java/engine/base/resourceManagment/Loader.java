package engine.base.resourceManagment;

import de.matthiasmann.twl.utils.PNGDecoder;
import engine.base.resourceManagment.containers.model.Mesh;
import engine.base.resourceManagment.containers.texture.TextureData;
...
public class Loader {
    ...
    public Mesh loadToVAO(float[] positions, float[] textureCoords, float[] normals,
                          int[] indices) {
        int vaoID = createVAO();
    ...
    public int loadTexture(String fileName) {
        ...
        try {
            ...
            GL11.glTexParameterf(GL11.GL_TEXTURE_2D, GL14.GL_TEXTURE_LOD_BIAS, -Config.getLodBias());
        } catch (Exception e) {
            e.printStackTrace();
