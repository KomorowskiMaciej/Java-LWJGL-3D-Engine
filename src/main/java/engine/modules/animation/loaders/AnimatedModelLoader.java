package engine.modules.animation.loaders;

import engine.modules.animation.animatedModel.AnimatedModel;
import engine.modules.animation.animatedModel.Joint;
import engine.modules.animation.openglObjects.Vao;
import engine.modules.animation.textures.Texture;
import engine.modules.resourceManagment.colladaParser.colladaLoader.ColladaLoader;
import engine.modules.resourceManagment.colladaParser.dataStructures.AnimatedModelData;
import engine.modules.resourceManagment.colladaParser.dataStructures.JointData;
import engine.modules.resourceManagment.colladaParser.dataStructures.MeshData;
import engine.modules.resourceManagment.colladaParser.dataStructures.SkeletonData;
